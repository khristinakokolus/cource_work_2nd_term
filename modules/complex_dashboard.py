...
app.layout = html.Div([
    html.Div([
        ...
        html.Div([
            dcc.Input(id='include-id', type='text', placeholder='Ingredients to include...', debounce=True,
                      style={"border": "2px solid #aaa", "border-radius": "4px",
        ...
        html.Div([
            html.Label("Choose if you want a cuisine, a diet or a dish type:",
                       style={'color': 'white', "font-weight": "550"}),
        ], style={"color": "white", "width": "100%", "display": "flex", "align-items": "center",
        ...
        html.Div([
            dcc.Dropdown(
                ...
                style={'width': '220px', 'font-size': '90%', 'height': '40px', 'marginBottom': '1em'},
            ),
            ], style={"width": "100%", "display": "flex", "align-items": "center",
                      "justify-content": "center", 'padding': "10", 'marginBottom': '1em'}
            ),
        html.Div([
            html.Label("BE SURE after the search DELETE NUMBER to PREVENT UPDATE while choosing other "
                       "parameters ",
                       style={'color': 'white', "font-weight": "550"}),
            ], style={"color": "white", "width": "100%", "display": "flex", "align-items": "center",
                      "justify-content": "center", 'marginBottom': '1em'}
        ...
        html.Div([
            html.Button('Click here to see the results and wait a bit', id='show-secret', n_clicks=0, className="btn"),
